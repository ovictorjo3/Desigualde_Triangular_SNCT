...
\author[Prof. Me. Rivas \& Joao Victor]{% 
Prof. Me. Rivas\inst{1} \and Joao Victor\inst{2} \and Jamily Lima\inst{3}}
...
\section*{Publicações}
	...
	\begin{frame}{Publicações}
		\begin{block}{Manaus Conference in Mathematics - UFAM - Março/26}
			\begin{itemize}
				\justifying
				\item Autores: Joao Victor, Jamily$^{*}$ e Prof. Rivas;
	...
	\begin{frame}{Solução}
		\begin{figure}[h]
			...
			\begin{subfigure}{0.45\textwidth}
				\centering
				\includegraphics[width=\linewidth]{imagens/macarrao.jpg}
				\caption{\justifying Macarrão de comprimento unitário}
			\end{subfigure}
			\hfill
			\begin{subfigure}{0.45\textwidth}
				\centering
				\includegraphics[width=\linewidth]{imagens/grafico.jpg}
				\caption{Representação geométrica}
			\end{subfigure}
			\caption{\justifying Registros de Representação Semiótica de Raymond Duval}
		\end{figure}
	\end{frame}
...
\begin{frame}{Referências}
	\begin{thebibliography}{99}
		\justifying
		\small
		\bibitem{dolce} DOLCE, O.; POMPEO, J. N. Fundamentos de Matemática Elementar 9 - 9. ed. - São Paulo: Atual, 2013. 
		\bibitem{OBMEP} Clubes de Matemática da OBMEP. Probleminha: Quem andou mais?. Disponivel em \href{https://clubes.obmep.org.br/blog/problema-quem-andou-mais/}{Desafio 1} 
		\bibitem{OBMEP} Clubes de Matemática da OBMEP. Probleminha: Brincando com lápis. Disponivel em: \href{https://clubes.obmep.org.br/blog/probleminha-brincando-com-lapis/}{Desafio 2} 
		\bibitem{OBMEP} Clubes de Matemática da OBMEP. Probleminha: Brincando com lápis. Disponivel em: \href{https://clubes.obmep.org.br/blog/problema-de-gincana-isso-nao-e-perimetro/}{Desafio 3} 
		\bibitem{ELITE} Elite Colégio e Pré-Vestibular Campinas. Unicamp 2024 - 1ª fase. Disponivel em: \href{https://sisq.elitecampinas.com.br/GabaritoVestibulares/VisualizarQuestao?id_questao_tipo=10200}{Desafio 4} 
		\bibitem{OBMEP} Clubes de Matemática da OBMEP. Probleminha: Problemão: Probabilidade com macarrão. Disponivel em: \href{https://clubes.obmep.org.br/blog/problemao-probabilidade-com-macarrao/}{Desafio 5}
